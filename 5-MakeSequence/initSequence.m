function sq = initSequence
    ...
    sq.digital(13).setName('SSB Carrier','B4').setDefault(0);
    ...
    sq.digital(25).setName('RS Microwave TTL','D0','Raycus 1').setDefault(0);
    ...
    sq.analog(1).setName('87 Cooling Freq EOM','AO/0').setDefault(5.058);
    sq.analog(2).setName('87 Cooling Amp EOM','AO/1').setDefault(0);
    sq.analog(3).setName('87 Repump Freq EOM','AO/2').setDefault(0);
    sq.analog(4).setName('87 Repump Amp EOM','AO/3').setDefault(10);
    ...
    sq.analog(17).setName('85 Repump AMP EOM','CO/0').setDefault(0);
    sq.analog(18).setName('3DVMOT Freq AOM','CO/1').setDefault(0);
    sq.analog(19).setName('CO/2 - DEAD','CO/2','DEAD').setDefault(0);
    sq.analog(20).setName('Imaging AOM Amp','CO/3').setDefault(3.3);
