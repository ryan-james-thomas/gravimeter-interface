...
if r.isInit()
    ...
    %Area of investigation of camera 
    TopEdge=401;
    BottomEdge=601;
    LeftEdge=101;
    RightEdge=901;
...
%     i2=1;
    ...
    c = Abs_Analysis_Internal(r.data.Tdrop,r.data.Detuning); %see top
...
function cloud = Abs_Analysis_Internal(tof,detuning)
...
fitdata = AtomCloudFit('roiRow',[TopEdge,BottomEdge],...%was 201
                       ...
                       'roiStep',1,...
                       'fittype','sum');    %Options: none, gauss1d, twocomp1d, bec1d, gauss2d, twocomp2d, bec2d, sum
